...
- **로컬 전용**: 측정 기록은 모두 내 PC에만 저장되고 외부로 전송되지 않습니다. (예외: 트레이 메뉴 **업데이트 확인**을 누를 때만 GitHub에서 최신 버전 번호를 조회하며, 이때도 내 데이터는 보내지 않습니다.)
...
**알림이 너무 자주/안 떠요.**
설정 → **알림** 에서 항목별로 켜고 끄거나, **알림 사용 (전체)** 로 모두 끌 수 있습니다.
